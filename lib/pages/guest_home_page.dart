...
//   Widget build(BuildContext context) {
//     final hotels = [
//       ["Hotel A", "assets/images/hotel.png", "Surabaya", "4.2"],
//       ["Hotel B", "assets/images/hotel.png", "Jakarta", "5.0"],
//       ["Hotel C", "assets/images/hotel.png", "Malang", "3.7"],
//       ["Hotel D", "assets/images/hotel.png", "Yogyakarta", "4.5"],
//     ];
...
//   const _HotelListView({required this.hotels});
...
//           return _HotelCard(
//             name: hotel.name,
//             image: "assets/images/hotel.png", // Use a default image or fetch from hotel data if available
//             city: hotel.locationId, // Assuming locationId is the city name
//             rate: hotel.rating.toString(), // Assuming rating is used as price for display
